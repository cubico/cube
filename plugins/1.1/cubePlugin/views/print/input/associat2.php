<?php 
	...
	$action_url=explode("/",Route::url($vars['scriptPath']));
...
?>
<span  class="<?php echo $class ?>" <?php echo $js; ?> name="<?php echo $vars['internalname']; ?>"><?php echo htmlentities($ret[0]->text, ENT_QUOTES, 'UTF-8'); ?></span>